                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#features">Child`s Pose</a></li>			
                            <li class="scroll-to-section"><a href="#our-classes">Isometric Row</a></li>		
                            <li class="scroll-to-section"><a href="#our-classes">Sitting Flexion</a></li>			
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        <h2>Stretching <em>Waist Posture</em></h2>
                        <img src="resources/assets/images/line-dec.png" alt="">
                        <p><b>차일드 포즈, 아이소메트릭 로우</b> 중 진행할 운동을 골라주세요.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="https://github.com/Multicampus-AI-service-development/Project-Data/blob/1cd8b0da3ad8186b1d28a780546a79382fd144c0/waist%20stretching%20images/Child's%20Pose.png?raw=true" alt="">
                        </div>
                        <div class="down-content">
                            <span>Strength Trainer</span>
                            	<input type="button" id="child-pose" value="Child's Pose" krExTitle="차일드 포즈" enExTitle="Child's pose" class="btn btn-info btn-lg"
									style="white-space: normal;">
	                            
                            <p><br>Bitters cliche tattooed 8-bit distillery mustache. Keytar succulents gluten-free vegan church-key pour-over seitan flannel.</p>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="https://vscomfortimages.s3.ap-south-1.amazonaws.com/wrongform/untitled-870.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>Muscle Trainer</span>
                            
                            	<input type="button" id="isometric-rows" value="Isometric Row" krExTitle="아이소메트릭 로우" enExTitle="Isometric-rows"	class="btn btn-info btn-lg"
									style="white-space: normal">
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqALidq4EUBsOCnuQnxhe28hgJAnMNbpuLggx8vOp1esIViN7nqgVXjO7IkJG2PtIge6s&usqp=CAU" alt="">
                        </div>
                        <div class="down-content">
