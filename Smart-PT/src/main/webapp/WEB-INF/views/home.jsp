                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#our-classes">Routine(Classes)</a></li>
    ...
    <section class="section" id="our-classes">
        <div class="container">
            ...
            <div class="row" id="tabs">
              <div class="col-lg-4">
                <ul>
                  <li><a href='#tabs-1'><img src="resources/assets/images/tabs-first-icon.png" alt="">First Training Class</a></li>
                  <li><a href='#tabs-2'><img src="resources/assets/images/tabs-first-icon.png" alt="">Second Training Class</a></a></li>
                  <li><a href='#tabs-3'><img src="resources/assets/images/tabs-first-icon.png" alt="">Third Training Class</a></a></li>
                  <li><a href='#tabs-4'><img src="resources/assets/images/tabs-first-icon.png" alt="">Fourth Training Class</a></a></li>
              ...
              <div class="col-lg-8">
                <section class='tabs-content'>
                  <article id='tabs-1'>
                    <img src="resources/assets/images/training-image-01.jpg" alt="First Class">
                  ...
                  <article id='tabs-2'>
                    <img src="resources/assets/images/training-image-02.jpg" alt="Second Training">
                  ...
                  <article id='tabs-3'>
                    <img src="resources/assets/images/training-image-03.jpg" alt="Third Class">
                  ...
                  <article id='tabs-4'>
                    <img src="resources/assets/images/training-image-04.jpg" alt="Fourth Training">
...
<audio id="aud" src="src" preload="auto" hidden="hidden" controls></audio>
