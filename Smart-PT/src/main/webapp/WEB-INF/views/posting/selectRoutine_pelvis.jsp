        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="resources/assets/images/routine/pelvis_1.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>Piriformis stretch</span>
                            <h4>이상근 스트레칭</h4>
                            <div class="form-check form-switch" style="text-align:right">
					  			<input class="form-check-input" type="checkbox" name="item" 
					  			value="이상근 스트레칭" id="flexSwitchCheckDefault" style="margin-top : -38px;">
					  		</div>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="resources/assets/images/routine/pelvis_2.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>Lunge with spinal twist</span>
                            <h4>런지 앤 트위스트</h4>
                            <div class="form-check form-switch" style="text-align:right">
					  			<input class="form-check-input" type="checkbox" name="item" 
					  			value="런지 앤 트위스트" id="flexSwitchCheckDefault" style="margin-top : -38px;">
					  		</div>
                            <p style="margin-top : -25px;">Bitters cliche tattooed 8-bit distillery mustache. Keytar succulents gluten-free vegan church-key pour-over seitan flannel.</p>
                            <ul class="social-icons">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="resources/assets/images/routine/pelvis_3.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>Lunging hip flexor stretch</span>
                            <h4>고관절 굴곡근 스트레칭</h4>
                            <div class="form-check form-switch" style="text-align:right">
					  			<input class="form-check-input" type="checkbox" name="item" 
					  			value="고관절 굴곡근 스트레칭" id="flexSwitchCheckDefault" style="margin-top : -38px;">
					  		</div>
                            <p style="margin-top : -25px;">Bitters cliche tattooed 8-bit distillery mustache. Keytar succulents gluten-free vegan church-key pour-over seitan flannel.</p>
                            <ul class="social-icons">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="resources/assets/images/routine/pelvis_4.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>Figure four stretch</span>
                            <h4>4자 스트레칭</h4>
                            <div class="form-check form-switch" style="text-align:right">
					  			<input class="form-check-input" type="checkbox" name="item" 
					  			value="4자 스트레칭" id="flexSwitchCheckDefault" style="margin-top : -38px;">
					  		</div>
                            <p style="margin-top : -25px;">Bitters cliche tattooed 8-bit distillery mustache. Keytar succulents gluten-free vegan church-key pour-over seitan flannel.</p>
                            <ul class="social-icons">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="resources/assets/images/routine/pelvis_5.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>Pretzel stretch</span>
                            <h4>프레첼 스트레칭</h4>
                            <div class="form-check form-switch" style="text-align:right">
					  			<input class="form-check-input" type="checkbox" name="item" 
					  			value="프레첼 스트레칭" id="flexSwitchCheckDefault" style="margin-top : -38px;">
					  		</div>
                            <p style="margin-top : -25px;">Bitters cliche tattooed 8-bit distillery mustache. Keytar succulents gluten-free vegan church-key pour-over seitan flannel.</p>
                            <ul class="social-icons">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="resources/assets/images/routine/pelvis_6.jpg" alt="">
                        </div>
                        <div class="down-content">
                            <span>Pigeon stretch</span>
                            <h4>비둘기 스트레칭</h4>
                            <div class="form-check form-switch" style="text-align:right">
					  			<input class="form-check-input" type="checkbox" name="item" 
					  			value="비둘기 스트레칭" id="flexSwitchCheckDefault" style="margin-top : -38px;">
					  		</div>
                            <p style="margin-top : -25px;">Bitters cliche tattooed 8-bit distillery mustache. Keytar succulents gluten-free vegan church-key pour-over seitan flannel.</p>
                            <ul class="social-icons">
                                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
